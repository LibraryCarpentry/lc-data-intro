...
1.  The published copy of the lesson is in the `gh-pages` branch of the repository
    ...
    and merge the [originating repository][repo]'s `gh-pages` branch into your `gh-pages` branch
...
2.  We use [GitHub flow][github-flow] to manage changes:
    ...
    4.  Submit a pull request from that branch to the [originating repository][repo].
